...
- RestTemplateBuilder is autowired and can be used to configure rest template

  i.e. builder.setConnectTimeout(Duration.ofMillis(30)).setReadTimeout(Duration.ofMinutes(2));
